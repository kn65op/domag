...
import io.github.kn65op.domag.dbtests.data.mainCategory1ItemsAmountCount
import io.github.kn65op.domag.dbtests.data.mainCategory1LimitAmount
import io.github.kn65op.domag.dbtests.data.mainCategory1Name
...
class ShortagePartTestSuite {
    ...
    fun shouldShowShortageItems() {
        assertCategoryInContents(mainCategory1Name, mainCategory1ItemsAmountCount, mainCategory1LimitAmount)
    }
}
